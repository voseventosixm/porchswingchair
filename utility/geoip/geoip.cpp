...
void _GeoIP_setup_dbfilename()
{
    if (NULL == GeoIPDBFileName) {
        ...
        #define MAP_ITEM(code, name) GeoIPDBFileName[code] = _GeoIP_full_path_to(name)

        MAP_ITEM(GEOIP_COUNTRY_EDITION,           "GeoIP.dat");
        MAP_ITEM(GEOIP_LARGE_COUNTRY_EDITION,     "GeoIP.dat");
        MAP_ITEM(GEOIP_CITY_EDITION_REV0,         "GeoLiteCity.dat");
        MAP_ITEM(GEOIP_CITY_EDITION_REV1,         "GeoLiteCity.dat");

        MAP_ITEM(GEOIP_COUNTRY_EDITION_V6,        "GeoIPv6.dat");
        MAP_ITEM(GEOIP_LARGE_COUNTRY_EDITION_V6,  "GeoIPv6.dat");
        MAP_ITEM(GEOIP_CITY_EDITION_REV0_V6,      "GeoLiteCityv6.dat");
        MAP_ITEM(GEOIP_CITY_EDITION_REV1_V6,      "GeoLiteCityv6.dat");

        MAP_ITEM(GEOIP_REGION_EDITION_REV0,       "GeoIPRegion.dat");
        MAP_ITEM(GEOIP_REGION_EDITION_REV1,       "GeoIPRegion.dat");
        MAP_ITEM(GEOIP_ISP_EDITION,               "GeoIPISP.dat");
        MAP_ITEM(GEOIP_ORG_EDITION,               "GeoIPOrg.dat");
        MAP_ITEM(GEOIP_PROXY_EDITION,             "GeoIPProxy.dat");
        MAP_ITEM(GEOIP_ASNUM_EDITION,             "GeoIPASNum.dat");
        MAP_ITEM(GEOIP_NETSPEED_EDITION,          "GeoIPNetSpeed.dat");
        MAP_ITEM(GEOIP_DOMAIN_EDITION,            "GeoIPDomain.dat");
        MAP_ITEM(GEOIP_LOCATIONA_EDITION,         "GeoIPLocA.dat");
        MAP_ITEM(GEOIP_ACCURACYRADIUS_EDITION,    "GeoIPDistance.dat");
        MAP_ITEM(GEOIP_ASNUM_EDITION_V6,          "GeoIPASNumv6.dat");
        MAP_ITEM(GEOIP_ISP_EDITION_V6,            "GeoIPISPv6.dat");
        MAP_ITEM(GEOIP_ORG_EDITION_V6,            "GeoIPOrgv6.dat");
        MAP_ITEM(GEOIP_DOMAIN_EDITION_V6,         "GeoIPDomainv6.dat");
        MAP_ITEM(GEOIP_LOCATIONA_EDITION_V6,      "GeoIPLocAv6.dat");
        MAP_ITEM(GEOIP_REGISTRAR_EDITION,         "GeoIPRegistrar.dat");
        MAP_ITEM(GEOIP_REGISTRAR_EDITION_V6,      "GeoIPRegistrarv6.dat");
        MAP_ITEM(GEOIP_USERTYPE_EDITION,          "GeoIPUserType.dat");
        MAP_ITEM(GEOIP_USERTYPE_EDITION_V6,       "GeoIPUserTypev6.dat");
        MAP_ITEM(GEOIP_NETSPEED_EDITION_REV1,     "GeoIPNetSpeedCell.dat");
        MAP_ITEM(GEOIP_NETSPEED_EDITION_REV1_V6,  "GeoIPNetSpeedCellv6.dat");
        MAP_ITEM(GEOIP_COUNTRYCONF_EDITION,       "GeoIPCountryConf.dat");
        MAP_ITEM(GEOIP_CITYCONF_EDITION,          "GeoIPCityConf.dat");
        MAP_ITEM(GEOIP_REGIONCONF_EDITION,        "GeoIPRegionConf.dat");
        MAP_ITEM(GEOIP_POSTALCONF_EDITION,        "GeoIPPostalConf.dat");
        MAP_ITEM(GEOIP_ACCURACYRADIUS_EDITION_V6, "GeoIPDistancev6.dat");
        ...
        if (stat(gi->file_path, &buf) != -1) {
            ...
            if (buf.st_mtime != gi->mtime &&
                ...
                if (gi->flags & GEOIP_MMAP_CACHE) {
                    ...
                    return;
#else
                    gi->cache = (unsigned char *) mmap(
                                NULL, buf.st_size, PROT_READ, MAP_PRIVATE, fileno(gi->GeoIPDatabase), 0);
